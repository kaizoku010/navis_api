...
app.get('/driver/:_id', async (req, res) => {
    try {
        ...
        const driverId = req.params._id;  // Extract the driver ID from the request parameters
        const request = await collection.findOne({ _id: driverId });  // Find the driver with the specific ID
